...
# Referenční informace k protokolům pro ATA SIEM
...
## Ukázky podezřelých aktivit ATA ve formátu CEF
...
-   msg – popis výstrahy
-   cnt – pro výstrahy, které obsahují počet, kolikrát byla výstraha vydaná (například u útoku hrubou silou s počtem pokusů o uhodnutí hesel)
...
### Podezřelá replikace adresářových služeb
...
### Škodlivý požadavek na soukromé informace přes Data Protection
...
### Zveřejnění důvěrných přihlašovacích údajů k účtu
...
### Služby zveřejňující přihlašovací údaje k účtu
