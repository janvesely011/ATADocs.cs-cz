...
2. Vyexportujte certifikát ATA Center.
    1. Ve správci certifikátů (`certlm.msc`) přejděte na **Certifikáty (místní počítač)** -> **Osobní** ->**Certifikáty** a vyberte **ATA Center**.
...
5. Na nově vytvořeném Windows Serveru postupujte podle pokynů pro [Nasazení ATA Center](/advanced-threat-analytics/deploy-use/install-ata-step1). Je nutné vybrat stejnou IP adresu a port jako pro staré centrum. ATA Gateways není potřeba znovu nasazovat. Po zobrazení výzvy k zadání certifikátu zadejte certifikát, který jste vyexportovali při zálohování konfigurace ATA Center. 
