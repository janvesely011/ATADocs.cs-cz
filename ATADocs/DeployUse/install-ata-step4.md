...
Před instalací ATA Gateway ověřte, že je zrcadlení portů správně nakonfigurované a že ATA Gateway vidí provoz do a z řadičů domény. Další informace najdete v tématu [Ověření zrcadlení portů](/advanced-threat-analytics/plan-design/validate-port-mirroring).
...
4.  V části **Konfigurace ATA Gateway** zadejte následující informace podle vašeho prostředí:
    ...
    -   KB 3047154
        ...
        > [!IMPORTANT]
        > -   Neinstalujte aktualizaci KB 3047154 na hostiteli virtualizace. Může způsobit, že zrcadlení portů přestane fungovat správně.
...
5.  Po dokončení instalace kliknutím na **Spustit** otevřete prohlížeč a přihlaste se ke konzole ATA.
