...
To se provádí tak, že otevřete **sledování výkonu** a přidat všechny čítače pro ATA Gateway. Je název příslušného objektu čítače výkonu: **Microsoft ATA Gateway**.
...
To se provádí tak, že otevřete **sledování výkonu** a přidat všechny čítače pro ATA Center. Je název příslušného objektu čítače výkonu: **Microsoft ATA Center**.
