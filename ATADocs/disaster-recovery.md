...
2. Importujte certifikátu, který jste zálohovali dříve, na nový server.
...
5. Importujte konfigurace zálohovaná ATA Center:
    ...
    4. Nezapomeňte definovat [**uživatele adresářových služeb**](install-ata-step2.md) a zvolit [**synchronizátor řadiče domény**](install-ata-step5.md). 
