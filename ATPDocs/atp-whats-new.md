...
Přečtěte si další informace o aktivitách ověřování NTLM [pomocí Windows Event 8004](configure-windows-event-collection.md##ntlm-authentication-using-windows-event-8004).
...
## <a name="azure-atp-release-293"></a>Azure ATP verze 2,93
