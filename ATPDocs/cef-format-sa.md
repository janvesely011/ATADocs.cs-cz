...
## <a name="azure-atp-security-alert-unique-external-ids"></a>Jedinečné externí identifikátory výstrah zabezpečení služby Azure ATP
...
### <a name="data-exfiltration-over-smb"></a>Data exfiltrace přes SMB
12-19-2018 14:17:46 ověření. Chyba 127.0.0.1 1 2018-12-19T12:17:34.645993 + 00:00 DC1 CEF 3288 SmbDataExfiltrationSecurityAlert ï» – 0 | Microsoft | ATP Azure | 2.60.0.0 | SmbDataExfiltrationSecurityAlert | Tisk Data exfiltrace over SMB | 10 | Start = 2018-12-19T12:14:12.4932821 Z App = SMB shost = KLIENT1 MSG = Eugene Jenkinse (Software inženýr) na DC2 zkopíroval podezřelé soubory do počítače KLIENT1. externalId=2030 cs1Label=url cs1=https\://contoso-corp.atp.azure.com:13000/securityAlert/3ca2ec9d-2c67-44cc-a2d6-391716611bb6 cs2Label=trigger cs2=new
...
### <a name="suspected-brute-force-attack-kerberos-ntlm"></a>Podezření na útok hrubou silou (Kerberos, NTLM)
10-29-2018 11:20:47 auth. Warning 192.168.0.202 1 2018-10-29T09:20:44.478827 + 00:00 DC3 CEF 3908 BruteForceSecurityAlert ï»-0 | Microsoft | ATP Azure | 2.52.5704.46184 | BruteForceSecurityAlert | Podezřelé chyby ověřování | 5 | začátek = 2018-10-29T09:19:44.9512286 Z aplikace = Kerberos shost = KLIENT1 MSG = podezřelá selhání ověřování, která signalizují potenciální útok hrubou silou, se zjistila z počítače KLIENT1. externalId=2023 cs1Label=url cs1=https\://contoso-corp.atp.azure.com/securityAlert/85042c8e-27fa-49b3-8667-dabc1aa31580 cs2Label=trigger cs2=new
...
### <a name="suspicious-additions-to-sensitive-groups"></a>Podezřelé přídavky citlivých skupin
